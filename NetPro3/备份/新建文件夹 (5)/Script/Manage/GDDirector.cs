...
public class GDDirector
{
    ...
    //
    //private IProtocolFactory factory = new ProtocolFactory();
    //public IProtocolFactory getCurrentFactory()
    //{
    //    if (factory == null)
    //    {
    ...
    public void UpdatePerFrame(float dt)
    {
        ...
        //获取协议号
        MessageStruct message = s_NetWorkManage.getCMsg();

        //传递给UI
        s_UILayerManage.UpdatePerFrame(dt, message.dest, message.cmd);

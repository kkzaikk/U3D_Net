...
public class SendreceiveManage 
{
    private static SendreceiveManage s_SendreceiveManage = null;
    public static SendreceiveManage getInstance()
    {
        if (s_SendreceiveManage == null)
        {
            s_SendreceiveManage = new SendreceiveManage();
        }
        return s_SendreceiveManage;
    }
    ...
    public void PushReceData(MessageStruct message)
    {
    ...
    public void PushSendData(MessageStruct message)
    {
    ...
    public MessageStruct getReceData()
    {
